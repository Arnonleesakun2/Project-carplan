<div class="rounded-[5px] max-w-[97%] my-[10px] p-[30px] mx-auto shadow-[1px_2px_6px_rgba(0,0,0,0.38)] border-solid border-[1px] border-[#DFDFDF]">
    <div class="w-full">
        <div class="w-full  pt-8">
            <img class="w-40 h-48 rounded-lg mx-auto border-solid border-[1px] border-[#514F59]" src="{{url('uploads/'.$employee->image)}}">
        </div>
    </div>
    <div class="w-[97%]  mx-auto text-[20px] py-[3px] text-text">
        <p>ข้อมูลสำคัญ</p>
    </div>
    <div class="w-[97%] mx-auto sm:grid sm:grid-cols-2 sm:gap-[1rem] lg:grid lg:grid-cols-4 lg:w-full lg:gap-[1rem] lg:my-[1rem]">
    ...
    <div class=" w-[97%] mx-auto sm:grid sm:grid-cols-2 sm:gap-[1rem] lg:grid lg:grid-cols-4 lg:w-full lg:gap-[1rem] lg:my-[1rem]">
        <div class="">
            <p>เลขที่บัญชี</p>
            <input value="{{ $employee->accountnumbers[0]->name ?? '' }}" type="text"
        ...
        <div class="">
            <p>สถานะพ้นสภาพ</p>
            <input value="{{ $employee->outsts->name ?? '' }}" type="text"
                class="input focus:outline-none h-[40px] w-full border-solid border-[1.5px] border-[#CED4DA] rounded-[8px]"readonly />
        </div>
    </div>
    <div class=" w-[97%] mx-auto sm:grid sm:grid-cols-2 sm:gap-[1rem] lg:grid lg:grid-cols-3 lg:w-full lg:gap-[1rem] lg:my-[1rem]">
        <div class="">
            <p>ที่อยู่ปัจจุบัน</p>
    ...
    <div class=" w-[97%] mx-auto sm:grid sm:grid-cols-2 sm:gap-[1rem] lg:grid lg:grid-cols-4 lg:w-full lg:gap-[1rem] lg:my-[1rem]">
        <div class="">
            <p>บริษัท</p>
            <input value="{{ $employee->companys->name ??''}}" type="text" class="input focus:outline-none h-[40px] w-full border-solid border-[1.5px] border-[#CED4DA] rounded-[8px]"readonly />
        </div>
        <div class="">
            <p>ตำแหน่ง</p>
            <input value="{{ $employee->positions->name }}" type="text" class="input focus:outline-none h-[40px] w-full border-solid border-[1.5px] border-[#CED4DA] rounded-[8px]"readonly />
        </div>
        <div class="">
            <p>หน้าที่</p>
            <input value="{{ $employee->mainlines->name }}" type="text" class="input focus:outline-none h-[40px] w-full border-solid border-[1.5px] border-[#CED4DA] rounded-[8px]"readonly />
        </div>
        <div class="">
            <p>เงินเดือน</p>
    ...
    <div class="btnbox mt-10 w-11/12 mx-auto mb-8">
        <div class="button text-center">
            <a class="py-[7px] px-[21px] bg-[#FF5861] text-white rounded-[10px] hover:bg-[#EF4C53] duration-300"  href="{{ url('/OutEmployees') }}">ย้อนกลับ</a>
        </div>
    </div>
</div>