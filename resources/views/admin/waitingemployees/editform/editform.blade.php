<form action="{{ url('/Newupdate') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="sm:grid sm:grid-cols-2 sm:gap-[1rem] lg:grid lg:grid-cols-4 lg:w-full lg:gap-[1rem] lg:my-[1rem]">
        <div class="">
            ...
            <input name="image" type="file"
                class="file-input file-input-borderedinput  h-[40px] w-full border-solid border-[1.5px] border-[#CED4DA] rounded-[8px]"
                accept=".png,.jpg,.jpeg" />
        </div>
    ...
    <div class=" sm:grid sm:grid-cols-2 sm:gap-[1rem] lg:grid lg:grid-cols-4 lg:w-full lg:gap-[1rem] lg:my-[1rem]">
        ...
        <div class="">
            ...
            <select name="nationlity"
                class="input h-[40px] w-full border-solid border-[1.5px] border-[#CED4DA] rounded-[8px]">
                <option value="{{ $employee->nationalitys->id ?? '' }}">{{ $employee->nationalitys->name ?? '' }}
                </option>
    ...
    <div class="sm:grid sm:grid-cols-2 sm:gap-[1rem] lg:grid lg:grid-cols-4 lg:w-full lg:gap-[1rem] lg:my-[1rem]">
        <div class="">
            <p>วันอนุญาต</p>
            <input name="caryearstart" value="{{ $employee->agedivingcards[0]->yearstart ?? '' }}" type="date"
                class="input h-[40px] w-full border-solid border-[1.5px] border-[#CED4DA] rounded-[8px]" />
        </div>
        <div class="">
            <p>วันสิ้นอายุ</p>
