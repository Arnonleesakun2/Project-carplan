{{-- ลูกค้า --}}
<dialog id="my_customer" class="modal  ">
    <div class="modal-box bg-white rounded-2xl shadow-custom">
        ...
        <div class="">
            <h3 class="text-[20px] font-bold text-black">เพิ่มลูกค้า</h3>
            <div class="pt-[20px]">
                <form id="form-customer" class="space-y-2" action="">
                    <div class="flex gap-2 items-center">
                        <input id="inputcustomer" name="customer" value="" type="text"
                            placeholder="ลูกค้า"
